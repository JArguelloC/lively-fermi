...
export const Button = ({ className = '', variant = 'primary', size = 'md', fullWidth = false, children, ...props }) => {
    ...
    return (_jsx("button", { className: `${baseStyles} ${variants[variant]} ${sizes[size]} ${fullWidth ? 'w-full' : ''} ${className}`, ...props, children: children }));
};
