        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center gap-8">
            <Link to="/" className="flex items-center" aria-label="Go to home">
              <img src="/logo.png" alt="Groove Logo" className="h-10" />
            </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/carrito" className="p-2 hover:bg-white/5 rounded-full transition-colors relative" aria-label="Cart">
              ...
              {totalItems > 0 && (
                <span data-cart-counter className="absolute -top-1 -right-1 bg-groove-gold text-black text-[10px] font-bold w-4 h-4 flex items-center justify-center rounded-full">
